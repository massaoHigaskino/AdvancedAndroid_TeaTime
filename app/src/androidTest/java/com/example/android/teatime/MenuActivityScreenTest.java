...
public class MenuActivityScreenTest {
    ...
    public void clickGridViewItem_OpensOrderActivity() {
        DataInteraction dataInteraction = onData(CoreMatchers.anything());
        dataInteraction.inAdapterView(withId(R.id.tea_grid_view)).onChildView(withChild(withText(R.string.green_tea_name)))
                .perform(click());
        onView(withId(R.id.tea_name_text_view))
                .check(ViewAssertions.matches(withText(R.string.green_tea_name)));
    }
