...
public class OrderSummaryActivityTest {
    ...
    @Rule
    public IntentsTestRule<OrderSummaryActivity> mIntentsTestRule = new IntentsTestRule<>(OrderSummaryActivity.class);
    ...
    public void clickSendEmailButton_SendsEmail() {
        ...
        intended(allOf(
                ...
                hasExtras(allOf(
                        hasEntry(equalTo(Intent.EXTRA_SUBJECT), equalTo("Freshly Brewed from TeaTime")),
                        hasEntry(equalTo(Intent.EXTRA_TEXT), equalTo("I just ordered a delicious tea from TeaTime. Next time you are craving a tea, check them out!"))
                        ))
        ));
    }
}